...
export default function AnnotationTarget({ imageUrl, setIsExpanded, isMobile }: { imageUrl: string; isExpanded: boolean; setIsExpanded: (isExpanded: boolean) => void; isMobile: boolean }) {
  const wh = [300, 200];
